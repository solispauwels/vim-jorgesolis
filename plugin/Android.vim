...
function Android()
	...
	autocmd BufNewFile,Bufread *.java imap <F7> <esc>:!cd "%:p:h/../../../../bin" && /home/jorge/Android/sdk/platform-tools/adb install -r %:t:r-debug.apk
	autocmd BufNewFile,Bufread *.java map <F7> :!cd "%:p:h/../../../../bin" && /home/jorge/Android/sdk/platform-tools/adb install -r %:t:r-debug.apk
	...
	autocmd BufNewFile,Bufread *.java imap <F8> <esc>:!/home/jorge/Android/sdk/tools/emulator -avd Test -verbose -shell -show-kernel -no-snapshot-load<cr>i
	autocmd BufNewFile,Bufread *.java map <F8> :!/home/jorge/Android/sdk/tools/emulator -avd Test -verbose -shell -show-kernel -no-snapshot-load<cr>
